...
export const productsApi = {
  ...
  updatePrice: (skuId, body) => api.patch(`/products/${skuId}/price`, body),
}
...
export const purchaseOrdersApi = {
  ...
  nlpPreview: (text) => api.post("/purchase-orders/nlp/preview", { text }),
};
...
export const invoicesApi = {
  ...
  // Returns an axios response with responseType blob — caller triggers browser download
  downloadPdf: (invoiceId) =>
    api.get(`/invoices/${invoiceId}/pdf`, { responseType: "blob" }),
  resend: (invoiceId) =>
    api.post(`/invoices/${invoiceId}/resend`),
};
...
export const portalApi = {
  ...
  downloadInvoicePdf: (invoiceId) =>
    portalApiClient.get(`/customer-portal/invoices/${invoiceId}/pdf`, { responseType: "blob" }),
};
