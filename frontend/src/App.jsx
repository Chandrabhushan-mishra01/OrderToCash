      ...
      <QueryClientProvider client={queryClient}>
        ...
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            {/* Orders: admin/controller/inventory_manager + dispute_manager/collections_analyst read-only */}
            <Route path="/orders" element={
              <RoleGuard allowed={['admin', 'dispute_manager', 'controller', 'inventory_manager', 'collections_analyst']}>
                <OrdersPage />
              </RoleGuard>
            } />
            ...
            {/* Invoices: admin + dispute_manager + collections_analyst */}
