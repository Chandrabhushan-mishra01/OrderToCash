...
const cardStyle = {
  background: 'var(--bg-800)', borderRadius: 14, padding: 24,
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        <div style={cardStyle}>
          ...
          >
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)' }}>📋 Structured Order Form</div>
              <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginTop: 2 }}>Select product and fill details</div>
            </div>
            {formExpanded ? <ChevronUp size={16} style={{ color: 'var(--text-muted)' }} /> : <ChevronDown size={16} style={{ color: 'var(--text-muted)' }} />}
          </div>
        ...
        <div style={cardStyle}>
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)' }}>✍️ Describe Your Order</div>
            </div>
            <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>Type naturally — our AI will extract the details</div>
          </div>
          ...
          {nlpPreview?.error && (
            <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid #fecaca', borderRadius: 8, padding: '10px 14px', fontSize: 13, color: '#dc2626' }}>
              {nlpPreview.error}
            </div>
          )}
        </div>
