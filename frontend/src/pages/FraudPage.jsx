                          ...
                          <td>
                            {(() => {
                              if (['approved', 'credit_approved'].includes(f.order_status) && f.hitl_resolved_by) {
                                return <span className="badge badge-amber">Override (Passed)</span>;
                              }
                              if (f.order_status === 'cancelled' && f.hitl_resolved_by) {
                                return <span className="badge badge-red">Rejected</span>;
                              }
                              return f.order_blocked ? <span className="badge badge-red">Blocked</span> : <span className="badge badge-gray">Passed</span>;
                            })()}
                          </td>
                        </tr>
                        {isExpanded && hasShap && (
